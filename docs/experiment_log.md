...
本节比较 Muon 在 Qwen3-30B-A3B LoRA 微调中的超参数表现。训练数据为 Legacy CoT 9,500 条，评估集为 `current_950`。除学习率和 weight decay 外，其余训练参数与 §3.2 一致。

### 6.1 Muon 配置

所有实验使用 PyTorch 2.10 的 `torch.optim.Muon`，并固定以下参数：
...
### 6.2 current_950 汇总结果

| Learning rate ＼ Weight decay | 0 | 0.01 | 0.05 |
|---|---:|---:|---:|
| 2e-4 | 87.16% (828/950) | 87.26% (829/950) | 86.95% (826/950) |
| 1e-3 | 87.26% (829/950) | 86.74% (824/950) | 87.37% (830/950) |

### 6.3 各类别明细

#### lr=2e-4

| 类别 | wd=0 | wd=0.01 | wd=0.05 |
|---|---:|---:|---:|
| bit_manipulation | 82.5% (132/160) | 82.5% (132/160) | 83.1% (133/160) |
| cipher | 99.4% (156/157) | 100.0% (157/157) | 100.0% (157/157) |
| cryptarithm_deduce | 10.6% (7/66) | 12.1% (8/66) | 7.6% (5/66) |
| cryptarithm_guess | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) |
| equation_numeric_deduce | 90.0% (54/60) | 90.0% (54/60) | 88.3% (53/60) |
| equation_numeric_guess | 14.3% (2/14) | 7.1% (1/14) | 7.1% (1/14) |
| gravity | 100.0% (160/160) | 100.0% (160/160) | 100.0% (160/160) |
| numeral | 100.0% (158/158) | 100.0% (158/158) | 100.0% (158/158) |
| unit_conversion | 100.0% (159/159) | 100.0% (159/159) | 100.0% (159/159) |
| **TOTAL** | **87.16% (828/950)** | **87.26% (829/950)** | **86.95% (826/950)** |

#### lr=1e-3

| 类别 | wd=0 | wd=0.01 | wd=0.05 |
|---|---:|---:|---:|
| bit_manipulation | 83.8% (134/160) | 81.9% (131/160) | 82.5% (132/160) |
| cipher | 100.0% (157/157) | 99.4% (156/157) | 99.4% (156/157) |
| cryptarithm_deduce | 7.6% (5/66) | 10.6% (7/66) | 12.1% (8/66) |
| cryptarithm_guess | 0.0% (0/16) | 0.0% (0/16) | 6.3% (1/16) |
| equation_numeric_deduce | 91.7% (55/60) | 90.0% (54/60) | 91.7% (55/60) |
| equation_numeric_guess | 14.3% (2/14) | 7.1% (1/14) | 14.3% (2/14) |
| gravity | 99.4% (159/160) | 99.4% (159/160) | 99.4% (159/160) |
| numeral | 100.0% (158/158) | 100.0% (158/158) | 100.0% (158/158) |
| unit_conversion | 100.0% (159/159) | 99.4% (158/159) | 100.0% (159/159) |
| **TOTAL** | **87.26% (829/950)** | **86.74% (824/950)** | **87.37% (830/950)** |

### 6.4 跨数据集优化器对比

固定模型、LoRA、batch size、训练轮数、seed 和 scheduler，在三组数据上分别训练六种优化器。
...
| 训练数据 | AdamW | Adam | Adam 8-bit | SGD | Momentum SGD | Muon |
|---|---:|---:|---:|---:|---:|---:|
| Low-quality CoT | 73.37% (697/950) | 65.58% (623/950) | 67.68% (643/950) | 31.16% (296/950) | 35.68% (339/950) | 45.37% (431/950) |
| Legacy CoT | 87.16% (828/950) | 87.05% (827/950) | 87.26% (829/950) | 29.89% (284/950) | 24.32% (231/950) | 86.42% (821/950) |
| Synthetic CoT | 90.95% (864/950) | 90.95% (864/950) | 90.84% (863/950) | 29.26% (278/950) | 22.11% (210/950) | 90.74% (862/950) |

#### Low-quality CoT

| 类别 | AdamW | Adam | Adam 8-bit | SGD | Momentum SGD | Muon |
|---|---:|---:|---:|---:|---:|---:|
| bit_manipulation | 43.1% (69/160) | 42.5% (68/160) | 43.8% (70/160) | 9.4% (15/160) | 11.2% (18/160) | 6.9% (11/160) |
| cipher | 80.9% (127/157) | 38.9% (61/157) | 46.5% (73/157) | 21.0% (33/157) | 0.0% (0/157) | 0.0% (0/157) |
| cryptarithm_deduce | 9.1% (6/66) | 4.5% (3/66) | 7.6% (5/66) | 1.5% (1/66) | 0.0% (0/66) | 0.0% (0/66) |
| cryptarithm_guess | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) | 6.2% (1/16) |
| equation_numeric_deduce | 51.7% (31/60) | 51.7% (31/60) | 56.7% (34/60) | 26.7% (16/60) | 16.7% (10/60) | 16.7% (10/60) |
| equation_numeric_guess | 7.1% (1/14) | 14.3% (2/14) | 14.3% (2/14) | 0.0% (0/14) | 0.0% (0/14) | 7.1% (1/14) |
| gravity | 91.9% (147/160) | 88.1% (141/160) | 89.4% (143/160) | 12.5% (20/160) | 9.4% (15/160) | 58.1% (93/160) |
| numeral | 100.0% (158/158) | 100.0% (158/158) | 100.0% (158/158) | 99.4% (157/158) | 94.9% (150/158) | 100.0% (158/158) |
| unit_conversion | 99.4% (158/159) | 100.0% (159/159) | 99.4% (158/159) | 34.0% (54/159) | 91.8% (146/159) | 98.7% (157/159) |
| **TOTAL** | **73.37% (697/950)** | **65.58% (623/950)** | **67.68% (643/950)** | **31.16% (296/950)** | **35.68% (339/950)** | **45.37% (431/950)** |

#### Legacy CoT

| 类别 | AdamW | Adam | Adam 8-bit | SGD | Momentum SGD | Muon |
|---|---:|---:|---:|---:|---:|---:|
| bit_manipulation | 83.1% (133/160) | 81.9% (131/160) | 83.8% (134/160) | 12.5% (20/160) | 9.4% (15/160) | 81.9% (131/160) |
| cipher | 100.0% (157/157) | 100.0% (157/157) | 100.0% (157/157) | 26.8% (42/157) | 19.7% (31/157) | 99.4% (156/157) |
| cryptarithm_deduce | 9.1% (6/66) | 9.1% (6/66) | 9.1% (6/66) | 0.0% (0/66) | 1.5% (1/66) | 7.6% (5/66) |
| cryptarithm_guess | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) | 0.0% (0/16) |
| equation_numeric_deduce | 90.0% (54/60) | 90.0% (54/60) | 90.0% (54/60) | 40.0% (24/60) | 26.7% (16/60) | 85.0% (51/60) |
| equation_numeric_guess | 7.1% (1/14) | 14.3% (2/14) | 7.1% (1/14) | 0.0% (0/14) | 7.1% (1/14) | 14.3% (2/14) |
| gravity | 100.0% (160/160) | 100.0% (160/160) | 100.0% (160/160) | 8.1% (13/160) | 11.2% (18/160) | 99.4% (159/160) |
| numeral | 100.0% (158/158) | 100.0% (158/158) | 100.0% (158/158) | 96.8% (153/158) | 68.4% (108/158) | 100.0% (158/158) |
| unit_conversion | 100.0% (159/159) | 100.0% (159/159) | 100.0% (159/159) | 20.1% (32/159) | 25.8% (41/159) | 100.0% (159/159) |
| **TOTAL** | **87.16% (828/950)** | **87.05% (827/950)** | **87.26% (829/950)** | **29.89% (284/950)** | **24.32% (231/950)** | **86.42% (821/950)** |

#### Synthetic CoT

| 类别 | AdamW | Adam | Adam 8-bit | SGD | Momentum SGD | Muon |
|---|---:|---:|---:|---:|---:|---:|
| bit_manipulation | 96.2% (154/160) | 96.9% (155/160) | 96.9% (155/160) | 13.8% (22/160) | 10.6% (17/160) | 97.5% (156/160) |
| cipher | 99.4% (156/157) | 98.7% (155/157) | 98.7% (155/157) | 21.0% (33/157) | 21.0% (33/157) | 98.7% (155/157) |
| cryptarithm_deduce | 12.1% (8/66) | 12.1% (8/66) | 12.1% (8/66) | 1.5% (1/66) | 0.0% (0/66) | 10.6% (7/66) |
| cryptarithm_guess | 12.5% (2/16) | 12.5% (2/16) | 6.2% (1/16) | 0.0% (0/16) | 0.0% (0/16) | 12.5% (2/16) |
| equation_numeric_deduce | 100.0% (60/60) | 100.0% (60/60) | 100.0% (60/60) | 26.7% (16/60) | 28.3% (17/60) | 100.0% (60/60) |
| equation_numeric_guess | 50.0% (7/14) | 50.0% (7/14) | 50.0% (7/14) | 0.0% (0/14) | 0.0% (0/14) | 50.0% (7/14) |
| gravity | 100.0% (160/160) | 100.0% (160/160) | 100.0% (160/160) | 5.0% (8/160) | 10.0% (16/160) | 99.4% (159/160) |
| numeral | 100.0% (158/158) | 100.0% (158/158) | 100.0% (158/158) | 98.1% (155/158) | 43.7% (69/158) | 100.0% (158/158) |
| unit_conversion | 100.0% (159/159) | 100.0% (159/159) | 100.0% (159/159) | 27.0% (43/159) | 36.5% (58/159) | 99.4% (158/159) |
| **TOTAL** | **90.95% (864/950)** | **90.95% (864/950)** | **90.84% (863/950)** | **29.26% (278/950)** | **22.11% (210/950)** | **90.74% (862/950)** |
