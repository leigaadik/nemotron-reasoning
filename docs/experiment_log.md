...
### 5.2 current_950 横向汇总

纵轴为训练集类型，横轴从左到右按模型参数量升序排列；`—` 表示尚未实验。

| 训练集 | Qwen3-0.6B | Qwen3-1.7B | Qwen3-4B | Qwen3-8B | Qwen3-14B | Qwen3-32B | Qwen3-30B-A3B |
|---|---:|---:|---:|---:|---:|---:|---:|
| zeroshot | 22.1% (210/950) | 24.8% (236/950) | — | — | — | — | — |
| Low-quality CoT | 38.9% (370/950) | 47.1% (447/950) | — | — | — | — | 70.2% (667/950) |
| Legacy CoT | 83.6% (794/950) | 85.8% (815/950) | — | — | — | — | 86.7% (824/950) |
| Synthetic CoT | 82.9% (788/950) | **89.2% (847/950)** | — | — | — | — | **91.2% (866/950)** |
...
| 类别 | 零样本 | Low-quality CoT | Legacy CoT | Synthetic CoT |
|---|---:|---:|---:|---:|
